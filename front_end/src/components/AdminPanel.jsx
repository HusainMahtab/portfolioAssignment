        ...
        <aside className='min-h-full w-full max-w-60 shadow-lg'>
          ...
          <div>
             <nav className='flex flex-col justify-center p-4 '>
                <Link to="all_projects" className='py-1 hover:bg-slate-100 hover:text-[#1a1a1a] px-2 rounded-md font-serif' >All Projects</Link>
                <Link to="all_users" className='py-1 hover:bg-slate-100 hover:text-[#1a1a1a] px-2 rounded-md font-serif'>All Users</Link>
                <Link to="all_user_messages" className='py-1 hover:bg-slate-100 hover:text-[#1a1a1a] px-2 rounded-md font-serif' >All Users Messages</Link>
             </nav>
          </div>
        </aside>
